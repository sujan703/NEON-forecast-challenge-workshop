...
# use the correlation matrix to see which predictors are highly correlated with each other and with our response variable (temperature). We want strong correlation between response and regressors, and no or weak correlation between regressors.
